...
class DataProcessingApp:
    ...
    def __init__(self, root):
        self.root = root
        self.root.title("老王出品 ： 远程数据处理  6.0 V")
    ...
    # def threads_excel_task(self):
    #     thread1=Thread(target=self.excel_task())
    #     thread2 = Thread(target=self.excel_columns_width_height())
    #     thread1.start()
    #     thread2.start()
    #
    #
    ...
    #
    # def excel_columns_width_height(self):
    #
    #     # 设置其余列的宽度为 10
    ...
    def background_excel_process_data(self):
        ...
        #     executor.submit(excel_process_data, progress)
