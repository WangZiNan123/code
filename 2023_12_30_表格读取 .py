...
b1 = '2024_1月斗山基站发电数据'  # 储存 EXCEL表格 的文件名称
# adress2 = 'C:/Users/FCK/Desktop/12/test/%s.xlsx' % b1
adress3 = "C:/Users/11016/Desktop/12345/{}.xlsx".format(b1)  # 储存 EXCEL表格文件 的路径
#  EXCEL格式为“某某 年，某某 月，某某 日” ，例如：”2023.10.1“这种格式.。"  年 . 月  . 日  "
year = 2024  # 年，表格的年
month = 1  # 月，表格的月

for i in range(1, 34):  # 遍历所有数据  i=8  range=31.   取值范围：8<= i <31
    # a1 = '2023.9.%s' % i
    ...
    # 读取Excel文件中的数据
    adress1 = 'C:/Users/11016/Desktop/a/斗山数据/2024.1/%s.xlsx' % a1  # 读取 EXCEL表格文件 的路径
